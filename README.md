...
Finally, add the following layer arns to its configuration. This adds dependencies not provided by the default 3.9 runtime (thanks [Klayers](https://github.com/keithrozario/Klayers)!):
